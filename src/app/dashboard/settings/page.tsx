  ...
  return (
    <div>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <div className="rounded-2xl bg-white dark:bg-neutral-900 p-6 ring-1 ring-black/5 dark:ring-white/10 lg:col-span-1">
          ...
          <dl className="mt-5 space-y-4 text-sm">
            <div>
              <dt className="text-neutral-400 dark:text-neutral-500">Index Number</dt>
              <dd className="mt-0.5 font-semibold text-ink dark:text-neutral-100">
                {student.indexNumber}
              </dd>
            </div>
            <div>
              <dt className="text-neutral-400 dark:text-neutral-500">Name</dt>
              <dd className="mt-0.5 font-semibold text-ink dark:text-neutral-100">
      ...
      <div className="mt-6 rounded-2xl bg-white dark:bg-neutral-900 p-6 ring-1 ring-black/5 dark:ring-white/10 lg:max-w-2xl">
        <h2 className="text-sm font-bold tracking-wide text-neutral-400 dark:text-neutral-500">
          CHANGE PASSWORD
        </h2>
        <ChangePasswordForm />
